...
export default function Home() {
  ...
  return (
    <div className="space-y-24">
      {/* HERO – no dark background */}
      <section className="relative text-center">
        <div className="mx-auto max-w-7xl px-6 py-24">
          <div className="inline-flex items-center gap-2 rounded-full border border-indigo-400/20 bg-indigo-400/10 px-3 py-1 text-indigo-700 text-xs font-semibold">
            Built for AEC • AI-powered visuals
          </div>
          <h1 className="mt-5 text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900">
            Photoreal results from any render —{' '}
            <span className="text-cyan-500">in minutes</span>
          </h1>
          <p className="mt-4 text-lg text-slate-600 max-w-3xl mx-auto">
            Lumely enhances CG renders, stages interiors, and explores design options while
            preserving geometry and materials. Fast, consistent, client-ready.
          </p>
          <div className="mt-8 flex items-center justify-center gap-4">
            <a
              href="/signin"
              className="px-6 py-3 rounded-xl bg-indigo-500 hover:bg-indigo-400 text-white font-semibold"
            >
              Start Free
            </a>
            <a
              href="/pricing"
              className="px-6 py-3 rounded-xl border border-slate-300 hover:border-slate-400 text-slate-700"
            >
              View Pricing
            </a>
          </div>
        ...
        <div className="text-center">
          ...
          <div className="mt-4 grid grid-cols-2 md:grid-cols-5 gap-6 opacity-70 px-6 max-w-5xl mx-auto">
            {['StudioOne', 'UrbanLab', 'Habitat Co.', 'Northside', 'Blueprint'].map((logo) => (
              <div key={logo} className="rounded-lg border border-slate-200 bg-white py-3 text-sm">
                {logo}
              </div>
            ))}
          </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 items-center">
              <div>
                ...
                <p className="mt-3 text-slate-300">
                  Keep geometry and materials intact while adding photoreal tone and clarity. Choose
                  Low / Medium / High quality — with ×2 / ×4 upscaling when you need it.
                </p>
      ...
      <section>
        ...
        <p className="text-center text-slate-600 mt-2">
          From rough to refined — without changing your workflow.
        </p>
        <div className="mt-8 grid gap-6 md:grid-cols-3 max-w-7xl mx-auto px-6">
          {[
            {
              t: 'Sign in & upload',
              d: 'Start a new job from your dashboard. 1080p–4K supported.',
              Icon: Upload,
            },
            {
              t: 'Enhance & upscale',
              d: 'Pick Low / Medium / High. ×2 / ×4 sharpness with material fidelity.',
              Icon: Wand2,
            },
            {
              t: 'Download & deliver',
              d: 'Client-ready output for decks, listings and approvals.',
              Icon: Zap,
            },
          ].map((s) => (
            <div
      ...
      <section className="text-center">
        ...
        <div className="mt-6">
          <a
            href="/signin"
            className="px-6 py-3 rounded-xl bg-indigo-500 hover:bg-indigo-400 text-white shadow"
          >
            Sign in to start
          </a>
        </div>
